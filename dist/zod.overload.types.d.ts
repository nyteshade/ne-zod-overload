 ...
 * }
 */
export type OverloadDecorator = (overloads: Overloads) => (target: any, propertyKey: string, descriptor: PropertyDescriptor) => PropertyDescriptor;
//# sourceMappingURL=../src/src/zod.overload.types.d.ts.map